...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"/>
  ...
  <title>User See reserved Events</title>
...
<body style="background: url(Image3.jpg);background-repeat: no-repeat;background-size: 100%;">
 ...
 <br>
 <br>
 <h1 style="text-align: center; color:firebrick">Reserved events </h1>
 ...
 <caption>List of books you used</caption>
  <thead>
    <tr>
      ...
      <th scope="col" style="text-shadow: 5px 5px 10px orange;">event name</th>
...
$sql="SELECT event_id, event_name, guest_fname, guest_lname, event_date  FROM event INNER JOIN guest on guest_id=guest_num INNER JOIN user_form ON event_nu=event_id WHERE name='$username';";
...
if($result){
  while($row=mysqli_fetch_assoc($result)){
    ...
    $event_date=$row['event_date'];
     ...
     <td>
     <button type="button" class="btn btn-light"><a href="Leave_Evento.php? LeaveID='.$event_id.'">Leave from event</a></button>
     </td>
