...
<br>
<br>
<h1 style="text-align: center; color:firebrick">Books Available</h1>
...
if($result){
  while($row=mysqli_fetch_assoc($result)){
    ...
    $status=$row['status'];
     ...
     <td scope="row" style="text-shadow: 5px 5px 10px orange;">'.$id.'</td>
     <td>'.$title.'</td>
     <td>'.$author.'</td>
     <td>'.$field.'</td>
     <td>'.$status.'</td>
     ...
     <td>
     <button type="button" class="btn btn-light"><a href="Reserve.php? ReserveID='.$id.'">Reserve this Book</a></button>
