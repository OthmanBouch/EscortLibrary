...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"/>
  ...
  <title>User See reserved rooms</title>
...
<body style="background: url(Image3.jpg);background-repeat: no-repeat;background-size: 100%;">
 ...
 <br>
<br>
<h1 style="text-align: center; color:firebrick">Reserved Room</h1>
...
$sql="SELECT id, name, roomid, floor, hall FROM user_form INNER JOIN room ON room_nu=room_num WHERE name='$username';";
...
if($result){
  while($row=mysqli_fetch_assoc($result)){
    ...
    $hall=$row['hall'];
     ...
     <td>
     <button type="button" class="btn btn-light"><a href="Leave_room.php? LeaveID='.$id.'">Leave from room</a></button>
     </td>
